...
namespace rst
{
	...
	struct Rectangle
	{
		...
		Rectangle(float top = 10000.f, float bot = -10000.f, float right = 10000.f, float left = -10000.f)
		:_top(top), _bot(bot), _right(right), _left(left)
		{}
	};
    ...
    private:
        ...
        std::optional<Texture> texture; // 纹理图像
